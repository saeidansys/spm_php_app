...
final class ServicePartnerProjectPlanConsumedAction extends BaseAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, $args): ResponseInterface
    {
        try {
            ...
            if (array_key_exists('c', $queryParams) && $queryParams['c'] == $base64Id ) {
                ...
                return $this->twig->render($response, 'ansys/service-partner-project-plan-consumed.twig', [
                    'spname' => $spName,
            ...
            return $this->handleThrowable($e, $response, 'Ansys ServicePartnerProjectPlanConsumedAction');
        }
    }
