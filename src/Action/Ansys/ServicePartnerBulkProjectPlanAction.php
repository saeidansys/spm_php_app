...
final class ServicePartnerBulkProjectPlanAction extends BaseAction
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, $args): ResponseInterface
    {
        try {
            ...
            if (array_key_exists('c', $queryParams) && $queryParams['c'] == $base64Id ) {
                ...
                return $this->twig->render($response, 'ansys/service-partner-bulk-project-plan.twig', ['spname' => $spName, 'errors' => $errors]);
            }
            else {
                return $response->withStatus(404);
            }
        } catch (Throwable $e) {
            return $this->handleThrowable($e, $response, 'Ansys ServicePartnerBulkProjectPlanAction');
        }
    }
